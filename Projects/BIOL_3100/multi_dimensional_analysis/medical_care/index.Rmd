...
![](../../R/Images/med_condition_dependent/si.png)
<br> This is great and all, but let's run an adonis test to see if there is a significant difference in answers from those who care for those with medical conditions and those who don't:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
adonis(si ~ demo$med_condition_dependent)
```
This shows that the differences in answers are not significant, according to care of those with medical conditions. <br>
...
![](../../R/Images/med_condition_dependent/cm.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
![](../../R/Images/med_condition_dependent/im.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
![](../../R/Images/med_condition_dependent/sd.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
![](../../R/Images/med_condition_dependent/se.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
![](../../R/Images/med_condition_dependent/gm.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
![](../../R/Images/med_condition_dependent/sci_comp.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
![](../../R/Images/med_condition_dependent/per_comm_orient.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
Now, Competency in Science: <br>
![](../../R/Images/med_condition_dependent/sci_comm_orient1.png)
...
<br> 
![](../../R/Images/med_condition_dependent/sci_comm_orient2.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
## Conclusion
Ultimately, what we can understand from all of this is that caring for those who have medical conditions does not lead to a difference in answering of questions.<br>
...
![](../../R/Images/med_condition_dependent/conclusion.gif)

<h3 style="text-align:right;font-size:180%;">[**NEXT**](https://pbischoff3.github.io/Projects/BIOL_3100/multi_dimensional_analysis/analysis/)