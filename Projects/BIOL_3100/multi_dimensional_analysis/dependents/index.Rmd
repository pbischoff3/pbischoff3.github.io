...
![](../../R/Images/dependents/si.png)
<br> This is great and all, but let's run an adonis test to see if there is a significant difference in how different number of dependents goals responded to science identity questions:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
adonis(si ~ demo$dependents)
```
This shows that the differences in answers are not significant, according to number of dependents. <br>
...
![](../../R/Images/dependents/sci_comp.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
![](../../R/Images/dependents/per_comm_orient.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
Now, Competency in Science: <br>
![](../../R/Images/dependents/sci_comm_orient1.png)
...
<br> 
![](../../R/Images/dependents/sci_comm_orient2.png)
<br>
And an Adonis test:
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
## Conclusion
Ultimately, what we can understand from all of this is that a student's number of dependents does not have a significant impact on the the differences in answers in our questions. <br>
...
![](../../R/Images/dependents/table.png)
<br> <br>

![](../../R/Images/dependents/conclusion.gif)

<h3 style="text-align:right;font-size:180%;">[**NEXT**](https://pbischoff3.github.io/Projects/BIOL_3100/multi_dimensional_analysis/medical_condition/)