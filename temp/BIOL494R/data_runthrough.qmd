---
title: "BIOL494R First Walkthrough"
format: 
  html:
    toc: true
editor: visual
...
library(readr)
library(ggplot2)
df <- read_csv("BIOL 494R Data Entry.csv", col_names = TRUE)
...
combined_plots <- grid.arrange(
  ...
  ncol = 1,
  heights = c(0.35, 0.35, 0.35)  # Set heights for the rows
)
...
```{r chi, message=FALSE, warning=FALSE}
# Chi Squared ####
